...
public class login implements ActionListener {
    ...
    public login() {
        ...
        f = new JFrame("Admin Login");//setting the name of frame
        //   f.setBackground(Color.WHITE);
        f.setLayout(null);
        f.setSize(1360, 750);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("general/icons/g2.gif"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("general/icons/log.jpg"));
